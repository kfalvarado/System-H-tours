...
<center><h1> Parametro  </h1></center> 
            <div class="page-header">
              </nav>
            </div>
            <nav class="nav nav-pills flex-column flex-sm-row">
              <a class="flex-sm-fill text-sm-center nav-link active" href="#">Parametro</a>
              <a class="flex-sm-fill text-sm-center nav-link"  aria-current="page" href="{{route('mostrar.parametro')}}">Parametro</a>
            </nav>
            ...
            <div class="row">
              <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> <center>Parametro</center></h4>
                   ...
                   <th class="text-dark bg-white">Acciones</th>
                        ...
                        <tbody>
                          ...
                          <tr class="text-white bg-dark">
                            <td> {{ $objeto['COD_PARAMETRO'] }} </td>
                            <td>{{ $objeto['PARAMESTROS'] }}</td>
                            <td>{{ $objeto['VALOR'] }}</td>
                            <td>{{ $objeto['USUARIO'] }}</td>
                            <td>{{ $objeto['FEC_CREACION'] }}</td>
                            <td>{{ $objeto['FEC_MODIFICACION'] }}</td>
                            <td><button type="button"  class="btn btn-info btn-sm"  data-toggle="modal" data-target="#modal-editar-{{ $parametro['COD_PARAMETRO'] }}"> <i class="mdi mdi-table-edit"></i>Editar</button> <button type="button"  class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#modal-eliminar-{{ $parametro['COD_PARAMETRO'] }}"><i class="mdi mdi-delete-forever"></i>Eliminar</button> </td>  
                          </tr>
                          
                              <!-- INICIO MODAL PARA EDITAR  -->
                <div class="modal-container">
                  <div class="modal fade bd-example-modal-lg" id="modal-editar-{{ $parametro['COD_PARAMETRO'] }}">
                   ...
                   <div class="modal-body">
                     <center>
                       <form action="{{ route('parametro.actualizar') }}" method="post">
                        @csrf  @method('PUT')


                        <input type="hidden" name="f" value="{{ $parametro['COD_PARAMETRO'] }}">
                         <label class="form-label">
                           Parametro
                           <input type='text' list="lista-programacion" value="{{ $parametro['PARAMETRO'] }}" name='parametro' class="form-control text-white bg-dark" required>
                         ...
                         <label class="form-label">
                         Valor
                           <input type='text' list="lista-programacion" value="{{ $parametro['VALOR'] }}" name='valor' class="form-control text-white bg-dark" required>
                           <datalist id="lista-programacion">
                             <option value="Periodo-2022-ene-1-004">
                           </datalist>
                           </input>
                         ...
                         <label class="form-label">
                         Usuario
                           <input type='text' list="lista-programacion" value="{{ $parametro['USUARIO'] }}" name='usuario' class="form-control text-white bg-dark" required>
                           <datalist id="lista-programacion">
                             <option value="Periodo-2022-ene-1-004">
                           </datalist>
                           </input>
                         ...
                         <label class="form-label">
                               Fecha creacion
                               <input type="date" value="{{ substr( $parametro['FEC_CREACION'],0,10 )}}"  name="creacion" readonly>
                         </label>
                         <label class="form-label">
                           Fecha modificacion
                           <input type="date" value="{{ substr($parametro['FEC_MODIFICACION'],0,10) }}"  name="modificacion" readonly>
                         </label>
                         <br>
                         <label class="form-label">
            ...
            <div class="modal-container">
             <div class="modal fade bd-example-modal-lg" id="modal-eliminar-{{ $parametro['COD_PARAMETRO'] }}">
                   <!-- COLOCARLE UN lg PARA TAMANO MEDIANO COLOCARLE UN sm PARA TAMANO PEQUENO -->
                          ...
                          <center>
                            <form action="{{ route('parametro.insertar') }}" method="post">
                             @csrf
                              <label class="form-label">
                                Parametro
                                <input type='text' list="lista-programacion" name='Parametro' class="form-control text-white" required>
                                <datalist id="lista-programacion">
                                  <option value="Periodo-2022-ene-1-004">
                                </datalist>
                                </input>
                              ...
                              <label class="form-label">
                                Valor
                                <input type='text' list="lista-programacion" name='Valor' class="form-control text-white" required>
                                <datalist id="lista-programacion">
                                  <option value="Periodo-2022-ene-1-004">
                                </datalist>
                                </input>
                              ...
                              <label class="form-label">
                              Usuario
                                <input type='text' list="lista-programacion" name='Usuario' class="form-control text-white" required>
                                <datalist id="lista-programacion">
                                  <option value="Periodo-2022-ene-1-004">
                                </datalist>
                                </input>
