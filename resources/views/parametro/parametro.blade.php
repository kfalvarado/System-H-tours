...
<main class="container">
        ...
        <div class="content-wrapper">
          <center> <h1>Parametro H Tours Honduras</h1> </center>
                    ...
                    <table class="table table-bordered table-contextual">
                      <thead>
                        <tr class="text-dark bg-white">
                          ...
                          <th class="text-dark bg-white">Parametro</th>
                          <th class="text-dark bg-white">Valor</th>
                          <th class="text-dark bg-white">Cod_usr</th>
                          <th class="text-dark bg-white">Fec_creacion</th>
                          <th class="text-dark bg-white">Fec_modificacion</th>
                        </tr>
                      </thead>
                      <tbody>
        ...
        <div class="modal-container">
            <div class="modal fade bd-example-modal-lg" id="dialogo1">
             ...
             <h4 class="modal-title">Ingresar Parametro</h4>
        ...
        <div class="modal-container">
             <div class="modal fade bd-example-modal-lg" id="dialogo3">
              ...
              <center>
              <form action="" method="post">
              <label class="form-label">¿ Desea eliminar parametro ?</label>
              <br>
