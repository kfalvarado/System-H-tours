...
<script>
  Swal.fire({
             icon: 'success',
             text: 'Pesona registrada Correctamente'
                       ...
                       <form action="{{ route('personas.actualizar') }}" method="post">
                        @csrf @method('PUT')
                         <label class="form-label">
                          <input type="hidden" name="cod" value="{{ $persona['COD_PERSONA'] }}" >
                           <b>Usuario</b>
                           <input type='text'  value="{{ $persona['USR'] }}" name='user' class="form-control bg-dark text-white" required readonly>
                          </label>
                         <label class="form-label">

                           <b>Nombre de  Usuario</b>
                           <input type='text'  value="{{ $persona['NOM_USR'] }}" name='nombre' class="form-control bg-dark text-white" required readonly>
                          </label>
                        </center>
                        {{-- div contenedor  --}}
                       ...
                       <form action="{{ route('personas.insertar') }}" method="post">
                        @csrf
                         <label class="form-label">
                           ...
                           <select class="form-control bg-dark text-white" name="user" id="user" required>
                        ...
                        {{-- fin centrado --}}
                          ...
                          <label for="" style="background-color: #0778b199"> <font color='white'> &nbsp;  Edad </font>  
                            <input type="number" id="edad" name="edad" placeholder="0" min="0" max="100" class="form-control bg-white text-dark"  required>
                          </label> 
                          <label for="" style="background-color: #0778b199"> <font color='white'> &nbsp; Identidad </font> 
                            <input type="tel"  onclick="tipopersona();"minlength="0" min="0" placeholder="0801-2000-09115" pattern="[0-9]{4}-[0-9]{4}-[0-9]{5}"id="identidad" name="identidad"  class="form-control p_input text-dark bg-white" required>
                          </label> 
                          <br>
                           {{-- centrado  --}}
                        &nbsp;
