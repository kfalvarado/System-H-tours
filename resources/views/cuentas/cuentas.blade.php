...
<div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
             <center><h1> Crear Cuentas </h1></center>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-contextual">
                        <thead>
                          <tr>
                            <tr class="text-dark bg-white"></tr>
                            <th class="text-dark bg-white" > # </th>
                            <th class="text-dark bg-white"> <b>CLASIFICACION</b> </th>
                            <th class="text-dark bg-white"> <b>NUMERO DE CUENTA</b> </th>
           ...
           <div class="modal-container">
            <div class="modal fade bd-example-modal-lg" id="dialogo1">
             ...
             <h4 class="modal-title">Ingresar  Nuevo Registro</h4>
             ...
             <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                ...
                <div class="modal-container">
                 <div class="modal fade bd-example-modal-lg" id="dialogo2">
                  ...
                  <div class="modal-header">
                  <h4 class="modal-title">Editar Crear Cuentas</h4>
                       <!-- <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button> -->
                  </div>
