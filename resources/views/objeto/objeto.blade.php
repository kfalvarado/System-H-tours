...
<main class="container">
        ...
        <div class="content-wrapper">
          <center> <h1>Objeto H Tours Honduras</h1> </center>
                    ...
                    <table class="table table-bordered table-contextual">
                      <thead>
                        <tr class="text-dark bg-white">
                          ...
                          <th class="text-dark bg-white">Des_objeto</th>
                          <th class="text-dark bg-white">Tip_objeto</th>
                        </tr>
                      </thead>
                      <tbody>
        ...
        <div class="modal-container">
            <div class="modal fade bd-example-modal-lg" id="dialogo1">
             ...
             <h4 class="modal-title">Ingresar Objeto</h4>
        ...
        <div class="modal-container">
             <div class="modal fade bd-example-modal-lg" id="dialogo3">
              ...
              <center>
              <form action="" method="post">
              <label class="form-label">¿ Desea eliminar Objeto ?</label>
              <br>
