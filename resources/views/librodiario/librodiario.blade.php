...
<p align="right" valign="baseline">
    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#dialogo1">(+) Nuevo</button> <a type="button" href="{{ route('pdf.librodiario') }}" class="btn btn-danger btn-sm"><i class="mdi mdi-file-pdf"></i>Generar PDF</a>
    ...
    <form class="form-search">
        <div class="input-group">
            <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                <input class="form-controlprueba form-text me-2 light-table-filter text-white" data-table="table_id" type="text" placeholder="Buscar en libro diario">
            </form> &nbsp;
