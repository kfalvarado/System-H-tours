...
<center><h1> Objetos  </h1></center> 
            ...
            <p align="right" valign="baseline">
              ...
              <a type="button" href="{{route('objetos.pdf')}}" class="btn btn-danger btn-sm"  ><i class="mdi mdi-file-pdf"></i>Generar PDF</a>
            ...
            <div class="row">
              <div class="col-lg-12 stretch-card">
                ...
                <div class="modal-container">
                  <div class="modal fade bd-example-modal-lg" id="modal-editar-{{ $objeto['COD_OBJETO'] }}">
