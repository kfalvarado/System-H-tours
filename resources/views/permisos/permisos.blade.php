                        ...
                        <center>
                            <form action="{{ route('permisos.insertar') }}" method="post">
                                ...
                                <label class="form-label">
                                    Seleccionar Rol
                                    <select class="form-control text-white" name="rol">
                                ...
                                <label class="form-label">
                                    Pantalla
                                    <select class="form-control text-white" name="objeto">
                                        @foreach ($objetos as $key)
                                            <option value="{{ $key['COD_OBJETO'] }}">{{ $key['OBJETO'] }}</option>
                                        @endforeach
    ...
    <div class="content-wrapper">
        ...
        <p align="right" valign="baseline">
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#dialogo1">(+)
                Nuevo</button>
            <a type="button" href="{{ route('pdf.permisos') }}" class="btn btn-danger btn-sm"><i
                                ...
                                @else
                                    @if (count($permisos) > 0)
                                        @foreach ($permisos as $key)
                                                ...
                                                <div class="modal fade bd-example-modal-lg"
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('permisos.actua') }}"
                                                                    method="post">
                                                                    @csrf @method('PUT')
                                                                    <input type="hidden" name="cod"
                                                                        value="{{ $key['COD_PERMISO'] }}">
                                                                    ...
                                                                    <center>
                                                                        <label class="form-label">
                                                                            ...
                                                                            <select class="form-control text-white"
                                                                                name="objeto">
                                                                                <option value="{{ $key['COD_OBJETO'] }}"
                                                                                    hidden selected>{{ $key['OBJETO'] }}
                                                                                </option>
                                                                                @foreach ($objetos as $new)
                                                                                    <option
                                                                                        value="{{ $new['COD_OBJETO'] }}">
                                                                                        {{ $new['OBJETO'] }}</option>
                                                                                @endforeach
                                                                            </select>
                                            ...
                                            <div class="modal-container">
                                                <div class="modal fade bd-example-modal-lg"
                                                    id="modal-eliminar-{{ $key['COD_PERMISO'] }}">
                                                    <!-- COLOCARLE UN lg PARA TAMANO MEDIANO COLOCARLE UN sm PARA TAMANO PEQUENO -->
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            <!-- CABECERA DEL DIALOGO EDITAR -->
                                                            ...
                                                            <div class="modal-body">
                                                                <center>
                                                                    <form action="{{ route('permisos.eliminar') }}"
                                                                        method="post">
                                                                        @csrf @method('DELETE')
